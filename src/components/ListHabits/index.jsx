...
const ListHabits = (props) => {
  const {
    weeks, getHabitsWeek, getHabitsWeekNumber,
    createPlannedDate, createResolvedDate
  } = props;
  return (
    <Grid container>
      <Grid item xs={12}>
                    ...
                    <List key={itemHabits.id}>
                      <StyledListItem>
                        ...
                        <Grid container direction="column">
                          <ListItemText
                            primary={
                              <Typography variant="h6" component="span">{itemHabits.name}</Typography>}
                            secondary={
                              <Typography variant="subtitle1" component="span">{itemHabits.description}</Typography>
                            }
                          />
                          <Calendar
